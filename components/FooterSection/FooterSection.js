                        ...
                        <div className="col-lg-3 col-md-6 m-0 p-0">
                            <div className="footer_4">
                                ...
                                <div className="social_iconss">
                                    <a target={"_blank"} rel="noreferrer" href="https://www.facebook.com/yourdevloper.io/"> <i className="fa-brands fa-facebook-f"></i></a>
                                    <a href="https://www.linkedin.com/in/rpm-host-59a06a264/"><i className="fa-brands fa-linkedin-in"></i></a>
                                    <a href="#"><i className="fa-brands fa-pinterest-p"></i></a>
                                    <a href="https://www.instagram.com/p/CgedHFAhd8F/?igshid=YmMyMTA2M2Y%3D"> <i className="fa-brands fa-instagram"></i></a>
